...
const socialLinks = [
  { href: "https://www.instagram.com/calikidsmobiliario/", label: "Instagram", Icon: IconInstagram },
];

// 👉 Información del negocio
const WHATSAPP_NUMBER = "593990077959"; // solo números, con código de país, sin '+' ni espacios
const WHATSAPP_DISPLAY = "+593 99 007 7959"; // como se muestra al usuario
      ...
      <footer className=" border-t border-white/10 text-white">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left gap-1">
              ...
              <div className="text-xs text-white/60 mt-1 max-w-[220px]">
                <p>Mobiliario infantil fabricado a medida. 100% en madera</p>
        ...
        <div className={styles.ftCopyRow}>
          <p className="text-xs text-white/50">
            © {new Date().getFullYear()} Cali Kids. Todos los derechos reservados.
          </p>
